...
testFail("const a;", "Expected a semicolon (1:6)");

testFail("let x;", "Expected a semicolon (1:4)");

testFail("const a = 1;", "Expected a semicolon (1:6)");

testFail("let a = 1;", "Expected a semicolon (1:4)");

testFail("for(const x = 0;;);", "Expected ';' in for statement (1:10)");

testFail("for(let x = 0;;);", "Expected ';' in for statement (1:8)");
